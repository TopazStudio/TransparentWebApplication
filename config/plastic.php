...
return [
    ...
    |
    */
    'index' => env('PLASTIC_INDEX', 'TransparentWebApplication'),
    ...
    'connection'     => [
        ...
        */
        'hosts'   => [
            'https://19rj8gg8gv:lomiumvvvv@first-cluster-7030002112.eu-central-1.bonsaisearch.net:443',
